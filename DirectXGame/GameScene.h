...
private:
	...
	uint32_t settingsSeTextureHandle_ = 0;
	KamataEngine::Sprite* settingsBgmSprite_ = nullptr;
	KamataEngine::Sprite* settingsSeSprite_ = nullptr;
	uint32_t settingsPredictionTextureHandle_ = 0;
	uint32_t settingsPredictionOnTextureHandle_ = 0;
	uint32_t settingsPredictionOffTextureHandle_ = 0;
	KamataEngine::Sprite* settingsPredictionSprite_ = nullptr;
	KamataEngine::Sprite* settingsPredictionOnSprite_ = nullptr;
	KamataEngine::Sprite* settingsPredictionOffSprite_ = nullptr;
	uint32_t settingsVolumeBarTextureHandle_ = 0;
	KamataEngine::Sprite* settingsSeVolumeBarSprite_ = nullptr;
	KamataEngine::Sprite* settingsBgmVolumeBarSprite_ = nullptr;
	...
	float settingsSelectionAnimationTime_ = 0.0f;
